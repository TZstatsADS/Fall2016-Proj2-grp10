...
Find.Path<-function(Start.Coord,TP,SP,FP,RP,WP,Nodes,Segments,Original.Segments,Distance,End.Coord,Run.Back){
...
# Result = Find.Path(Start.Coord,TP,SP,FP,RP,WP,Nodes,Segments,Original.Segments,Distance,End.Coord,Run.Back=1)
# EDGE = Result$Edge
